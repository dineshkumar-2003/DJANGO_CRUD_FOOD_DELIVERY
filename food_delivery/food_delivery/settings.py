...
SECRET_KEY = 'django-insecure-*t)+n_)=e8&so*m3z()9d)yna-g2k+v3s#rj-gr&d(aid=2ym%'
...
LOGIN_URL="/login/"
LOGIN_REDIRECT_URL = "/index.html"  # Redirect to home after login
LOGOUT_REDIRECT_URL = "/"  # Redirect to home after logout
LOGOUT_VIEW = {"next_page": LOGOUT_REDIRECT_URL}
